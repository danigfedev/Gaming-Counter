...
public class Timer : MonoBehaviour {
    ...
    [Tooltip("This flag allows the user to force the screen to remain awake during all the lifecycle of the app.")]
    public bool ForceScreenAwake;//Idea: Make this bool accesible from App config
    public Text chrono;
